...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference("Detail.count") do
      post details_url, params: { detail: { email: @detail.email, name: @detail.name, phone: @detail.phone } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { email: @detail.email, name: @detail.name, phone: @detail.phone } }
